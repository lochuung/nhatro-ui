            ...
            <header className="container-fluid d-flex py-6 mb-4">
                ...
                <div className="d-flex align-items-center ms-auto me-n1 me-lg-n2">
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end">
                            <li>
                                <h6 className="dropdown-header text-uppercase">Select language</h6>
                            </li>
                            <li>
                            ...
                            <div className="list-group list-group-flush">
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Mochahost.com</h5>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Harry</h5>
                                                <small className="text-muted">32 minutes ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Farewell card</p>
                                                <small className="text-secondary">
                                                    Hi everyone, thanks to all who have already signed and
                                                    contributed to Ellie's leaving card.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Gavin</h5>
                                                <small className="text-muted">55 minutes ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Weekly cath up</p>
                                                <small className="text-secondary">
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Pamela - HR</h5>
                                                <small className="text-muted">1 hour ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">New starter</p>
                                                <small className="text-secondary">
                                                    I wanted to introduce Alan to you all, who starts today in
                                                    the Operations Team as our new Global Payroll &amp;
                                                    Benefits Manager.
                                                </small>
                                            </div>
                                        </div>
                                ...
                                >
                                    <div className="d-flex">
                                        <div className="avatar avatar-circle avatar-xs me-2">
                                            <span className="avatar-title text-bg-primary-soft">S</span>
                                        </div>
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">service.paypal.com</h5>
                                                <small className="text-muted">3 hours ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">You have a Payout!</p>
                                                <small className="text-secondary">
                                                    Please note that it may take a little while for this
                                                    payment to appear in the Activity section of your account.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        <div className="avatar avatar-circle avatar-xs me-2">
                                            <span className="avatar-title text-bg-primary-soft">C</span>
                                        </div>
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">CookieYes</h5>
                                                <small className="text-muted">5 hours ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Welcome to CookieYes!</p>
                                                <small className="text-secondary">
                                                    Welcome to CookieYes! Thank you for creating an account
                                                    with us.
                                                </small>
                                            </div>
                                        </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Andrew</h5>
                                                <small className="text-muted">6 hours ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Congratulations! - and thank you</p>
                                                <small className="text-secondary">
                                                    Thank you so much for continuing to leave no stone
                                                    unturned in pursuit of new milestones of success.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Helen</h5>
                                                <small className="text-muted">9 hours ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Bank Holidays season starts tomorrow</p>
                                                <small className="text-secondary">
                                                    Our office will be closed on these days, as it will also
                                                    be on Friday 6 May.
                                                </small>
                                            </div>
                                        </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Tiffany</h5>
                                                <small className="text-muted">1 day ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">External meetings and events</p>
                                                <small className="text-secondary">
                                                    We have updated our external meeting and events protocol.
                                                    Please have a look at the office board.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        <div className="avatar avatar-circle avatar-xs me-2">
                                            <span className="avatar-title text-bg-danger-soft">II</span>
                                        </div>
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Ionos Info</h5>
                                            ...
                                            <div className="d-flex flex-column">
                                                ...
                                                <small className="text-secondary">
                                                    Happy with your product or service? Sign up for the IONOS
                                                    Referral Program to recommend us to your business
                                                    partners, friends or family. We'll reward you with
                                                    attractive commissions when they place an order.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Edward</h5>
                                                <small className="text-muted">3 days ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Website change request</p>
                                                <small className="text-secondary">
                                ...
                                >
                                    <div className="d-flex">
                                        <div className="avatar avatar-circle avatar-xs me-2">
                                            <span className="avatar-title text-bg-primary">BT</span>
                                        </div>
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Bootstrap Themes</h5>
                                                <small className="text-muted">3 days ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Greg</h5>
                                                <small className="text-muted">4 days ago</small>
                                            </div>
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Greg Smith (Jira) 2</p>
                                                <small className="text-secondary">
                                                    [JIRA] (WEB-1022) Add Full Width Video Content Block to
                                                    microsites
                                                </small>
                                            </div>
                                        </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            ...
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">Hard drive limit</p>
                                                <small className="text-secondary">
                                                    Your hard drive is close to its storage cap. Once
                                                    exceeded, you can't add new items or sync changes.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        <div className="avatar avatar-circle avatar-xs me-2">
                                            <span className="avatar-title text-bg-info">RC</span>
                                        </div>
                                        <div className="d-flex flex-column flex-grow-1">
                                            <div className="d-flex w-100 justify-content-between">
                                                <h5 className="mb-1">Rave Coffee</h5>
                                            ...
                                            <div className="d-flex flex-column">
                                                ...
                                                <small className="text-secondary">
                                                    Login to your Rave account to place your order and you
                                                    will automatically earn double points on every $ spent.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1">
                                            ...
                                            <div className="d-flex flex-column">
                                                <p className="mb-1">John Po (Jira)</p>
                                                <small className="text-secondary">
                                                    Improving slide arrows and indicators on gift impact,
                                                    testimonial and victories module
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-4 d-flex justify-content-center align-items-center">
                                        <a
                                            ...
                                            className="d-inline-block link-secondary fs-5 fw-semibold text-center p-3"
                                        >
                                            <span className="avatar avatar-sm w-35px h-35px avatar-circle">
                                                <span className="avatar-title text-bg-primary-soft">D</span>
                                            </span>
                                            Dashboard
                                        </a>
                                    </div>
                                                ...
                                                >
                                                    <style
                                                        ...
                                                        dangerouslySetInnerHTML={{
                                                            __html:
                                                                ".st200{fill:url(#SVGID_1_);}.st201{fill:#FFFFFF;}"
                                                        }}
                                                    />
                                                    <linearGradient
                                                        id="SVGID_1_"
                    ...
                    >
                        <div className="offcanvas-body pt-7 pb-5 position-relative">
                            ...
                            <hr/>
                            <h4 className="mb-0">Color Scheme</h4>
                            <p className="text-secondary fs-5 mb-4">
                                Overall light or dark presentation.
                            </p>
                            <div
                                className="btn-group w-100 mb-7"
                                role="group"
                            ...
                            >
                                ...
                                />
                                <label
                                    className="btn btn-outline-primary px-3 w-100 d-flex align-items-center justify-content-center"
                                    htmlFor="lightMode"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <h4 className="mb-0">Navigation Color</h4>
                            <p className="text-secondary fs-5 mb-4">
                            ...
                            >
                                ...
                                <label
                                    className="btn btn-outline-primary w-50"
                                    htmlFor="invertedColor"
                                >
                                    Inverted
                                </label>
                            </div>
                            <h4 className="mb-0">Sidebar behaviour</h4>
                            <p className="text-secondary fs-5 mb-4">
                            ...
                            >
                                ...
                                />
                                <label
                                    className="btn btn-outline-primary px-3 w-100"
                                    htmlFor="fixed"
                                >
                                    Fixed
                                </label>
                            ...
                            <div className="row gx-4 mt-auto">
